...
import algoritmos.GrafoDirigido;
...
public class ParserArchivoGrafoTest extends TestCase{
    ...
    public void testParsearArchivoGrafoDirigido1() {
        ParserArchivoGrafo parser = new ParserArchivoGrafo();

        GrafoDirigido grafo = parser.parsearGrafoDirigido("src/tests/grafoDirigidoTest1.txt");
        ...
        LinkedList<Integer> adyacentes1 = grafo.getVerticesAdyacentesA(1);
        assertEquals(0, adyacentes1.size() );
    }
    ...
    public void testParsearArchivoGrafoDirigido2() {

        ParserArchivoGrafo parser = new ParserArchivoGrafo();

        GrafoDirigido grafo = parser.parsearGrafoDirigido("src/tests/grafoDirigidoTest2.txt");
        ...
        LinkedList<Integer> adyacentes2 = grafo.getVerticesAdyacentesA(2);
        assertEquals(0, adyacentes2.size() );

        LinkedList<Integer> adyacentes3 = grafo.getVerticesAdyacentesA(3);
        assertEquals(0, adyacentes3.size() );
        ...
        LinkedList<Integer> adyacentes5 = grafo.getVerticesAdyacentesA(5);
        assertEquals(0, adyacentes5.size() );
